...
* [0 - Aclaraciones](README.md)
* [1 - Indique la información de su empresa](pasos-para-registrar/1-indique-la-informacion-de-su-empresa.md)
* [2 - Elegir dónde pueden tramitar las compras los clientes](pasos-para-registrar/2-elegir-donde-pueden-tramitar-las-compras-los-clientes.md)
* [3 - Seleccione sus plataformas de terceros](pasos-para-registrar/3-seleccione-sus-plataformas-de-terceros.md)
* [4 - Defina sus preferencias de correo electrónico](pasos-para-registrar/4-defina-sus-preferencias-de-correo-electronico.md)

## Registrar como CSS

* [Requisitos mínimos del programa de CSS](registrar-como-css/requisitos-minimos-del-programa-de-css.md)
